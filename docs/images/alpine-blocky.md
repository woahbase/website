...
| BLOCKY_CACHEDIR     | /config/cache                    | Optional directory to cache downloaded lists on disk. Provisioned to exist by default, but only used when enabled in configuration. {{ m.sincev('0.32.0_20260620') }}
